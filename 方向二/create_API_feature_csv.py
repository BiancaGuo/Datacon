...
if __name__ =="__main__":
    ...
    # data_path="F:\\stage2_dataset\\stage2_dataset\\"
    # id = []
    # safe_type = []
    # api = []
    # count=0
    ...
    #         dataframe.to_csv("API_name_feature_small.csv", index=False, sep=',')
    #         id=[]
    #         safe_type=[]
    #         api=[]
    #     if count%1000==0:
    #         print(count)
    #         dataframe = pd.DataFrame({'id': id, 'api': api})
    #         dataframe.to_csv("API_name_feature_small.csv", mode="a",index=False, sep=',')
    #         id = []
    #         safe_type = []
    #         api = []
    ...
    data = pd.read_csv(r"API_name_feature_small.csv")
    ...
    data.to_csv("API_name_feature_small.csv", index=False, sep=',')